  ...
  describe "Epicbot.Slack.Signature" do
    describe "isValid" do
      it "returns true for a valid signature" do
        let
          secret = SigningSecret.fromString "8f742231b10e8888abcd99yyyzzz85a5"

          signature = Signature.fromString "v0=a2114d57b48eac39b9ad189dd8316235a7b4a8d21a10bd27519666489c69b503"
      ...
      it "returns true for an invalid signature" do
        let
          secret = SigningSecret.fromString "8f742231b10e8888abcd99yyyzzz85a5"

          signature = Signature.fromString "v0=bad"
